...
const PayrollOverrides: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        ...
        <DataGrid.Column field='jobCode' header='Job Code' filter width={200} />
        <DataGrid.Column field='payCode' header='Pay Code' filter width={200} />
        <DataGrid.Column field='costComponent' header='Cost Component' filter width={200} />
...
export default PayrollOverrides;
